...
dir="/Users/raunavghosh/Documents/Arnav Sir's project work/Anemia Detection using Palpable Palm Image Datasets from Ghana/Palm"

# URL for curl request (replace with your actual URL)
url="43.205.22.212:5000/predict"
# Directory to save files with "true" parameter value
true_dir="palm_detected_anemia"
# Directory to save files with "false" parameter value
false_dir="palm_detected_nonanemia"
