...
def get_efficientnetv2b1():
    cnn = keras.applications.EfficientNetV2B1(
        include_top=False,
        weights="weights/weights_palm/efficientnetv2-b1_notop.h5",
        input_tensor=None,
        input_shape=(227, 227, 3),
        include_preprocessing=True,
    )
    ...
    classifier.load_weights("weights/weights_palm/anemia-classifier-efficientNetB1.h5")
    return model
...
def get_efficientnetv2b2():
    cnn = keras.applications.EfficientNetV2B2(
        include_top=False,
        weights="weights/weights_palm/efficientnetv2-b2_notop.h5",
        input_tensor=None,
        input_shape=(227, 227, 3),
        include_preprocessing=True,
    )
    ...
    classifier.load_weights("weights/weights_palm/anemia-classifier-efficientNetB2.h5")
    return model
